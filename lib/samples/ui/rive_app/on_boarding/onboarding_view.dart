...
import 'package:scratch/samples/ui/rive_app/on_boarding/signin_view.dart';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: const Text(
                              "Welcome to Fitmetric",
                              style: TextStyle(
                                  fontFamily: "Poppins", fontSize: 50),
                            ),
                          ),
                          Text(
                            "FitMetric is designed to revolutionize personal health and wellness by providing a comprehensive platform that seamlessly integrates various tools and features. ",
                            style: TextStyle(
                  ...
                  const SizedBox(height: 16),
                  Text(
                    "Developed by Amit Kumar Singh, Keeping your privacy in Mind.",
                    style: TextStyle(
                        color: Colors.black.withOpacity(0.7),
                        fontFamily: "Inter",
                        fontSize: 13),
